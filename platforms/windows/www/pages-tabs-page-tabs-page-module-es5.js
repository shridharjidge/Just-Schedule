...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-tabs-page-tabs-page-module"], {
            ...
            var TaskService = /** @class */ (function () {
               ...
               */
                function TaskService(db) {
                    ...
                    this.Tasks = this.taskscollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SchedulePage = /** @class */ (function () {
                function SchedulePage(alertCtrl, confData, loadingCtrl, modalCtrl, router, toastCtrl, user, config, taskService) {
                ...
                SchedulePage.prototype.onFabClick = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SessionDetailPage = /** @class */ (function () {
                function SessionDetailPage(dataProvider, userProvider, route, taskService, config) {
                ...
                SessionDetailPage.prototype.ngOnInit = function () {
                    var _this = this;
                    this.taskService.gettasks().subscribe(function (data) {
                        _this.tasks = data;
                    });
                ...
                SessionDetailPage.prototype.shareSession = function () {
                    console.log('Clicked share session');
                };
                SessionDetailPage.prototype.deleteSession = function () {
                };
                    ...
                    children: [
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: 'new',
                                    loadChildren: function () { return __webpack_require__.e(/*! import() | new-new-module */ "new-new-module").then(__webpack_require__.bind(null, /*! ../new/new.module */ "./src/app/pages/new/new.module.ts")).then(function (m) { return m.NewPageModule; }); }
                                }
                            ]
                        },
                        {
